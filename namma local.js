const SCRIPT_URL = ' https://script.google.com/macros/s/AKfycbzru8LrBzdFLPdLf2beVsKKFeCPN98HU7u40Ax5XNWOcyFRnkm-tVSufjiELEVB-QNy/exec ';
...
function renderCards(dataToRender = dataList) {
    ...
    dataToRender.forEach(item => {
        ...
        let iconHtml = '<i class="fa-solid fa-taxi"></i>'; 
        let typeBadge = 'Auto / Cab';
        
        if(type.toString().toLowerCase() === 'cat2') { iconHtml = '<i class="fa-solid fa-building-columns"></i>'; typeBadge = 'Marriage Halls'; }
        if(type.toString().toLowerCase() === 'cat3') { iconHtml = '<i class="fa-solid fa-gifts"></i>'; typeBadge = 'Event Planners'; }
