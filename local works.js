const SCRIPT_URL = ' https://script.google.com/macros/s/AKfycbyRKEi14MplPQ2MdnblRnTsolym-we1aSLl9927ji8ruZq2it0zAL6d5LRBbvzXUt57/exec ';
...
function renderCards(dataToRender = dataList) {
    ...
    dataToRender.forEach(item => {
        ...
        let iconHtml = '<i class="fa-solid fa-paint-roller"></i>'; 
        let typeBadge = 'Painters';
        
        if(type.toString().toLowerCase() === 'cat2') { iconHtml = '<i class="fa-solid fa-broom"></i>'; typeBadge = 'Cleaners'; }
        if(type.toString().toLowerCase() === 'cat3') { iconHtml = '<i class="fa-solid fa-truck-ramp-box"></i>'; typeBadge = 'Load Men'; }
        if(type.toString().toLowerCase() === 'cat4') { iconHtml = '<i class="fa-solid fa-seedling"></i>'; typeBadge = 'Gardeners'; }
