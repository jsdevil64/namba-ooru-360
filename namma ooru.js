const SCRIPT_URL = ' https://script.google.com/macros/s/AKfycbxkQR2S_usZR2v-6tNuL9F9FxpHXS_ld5GXkPOspP2WXhj73NEId_oFdcwH0GOEXNYa/exec';
...
function renderCards(dataToRender = dataList) {
    ...
    dataToRender.forEach(item => {
        ...
        let iconHtml = '<i class="fa-solid fa-hotel"></i>'; 
        let typeBadge = 'PG & Rooms';
        
        if(type.toString().toLowerCase() === 'cat2') { iconHtml = '<i class="fa-solid fa-utensils"></i>'; typeBadge = 'Homely Mess'; }
        if(type.toString().toLowerCase() === 'cat3') { iconHtml = '<i class="fa-solid fa-heart-pulse"></i>'; typeBadge = 'Clinics'; }
